...
export PATH
#==================================================================#
# Description: Autoinstall Shadowsocks-libev Server for CentOS 6/7 #
# Author: https://github.com/teddysun/shadowsocks_install          #
...
libsodium_url="https://cdn.xiazaio.win/resource/libsodium-1.0.16.tar.gz"

mbedtls_file="mbedtls-2.6.0"
mbedtls_url="https://cdn.xiazaio.win/resource/mbedtls-2.6.0-gpl.tgz"
...
get_latest_version(){
    ...
    init_script_link="https://cdn.xiazaio.win/resource/shadowsocks-libev"
}
...
print_info(){
    clear
    echo "#==================================================================#"
    echo "# Description: Autoinstall Shadowsocks-libev Server for CentOS 6/7 #"
...
pre_install(){
    ...
    if check_sys sysRelease centos; then
        ...
        if centosversion 5; then
            echo -e "[${red}Error${plain}] Not support CentOS 5, please change to CentOS 6/7 and try again."
            exit 1
        fi
    else
    ...
    read -p "(Default password: Auh186925):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="Auh186925"
    echo
    echo "---------------------------"
